  ...
  <div class="main-content" style="width: 20%;">
    <?php
      ...
      while($row4 = $resultat4->fetch()){
        if($row4['is_done'] == 1) {
          echo "<h3>{$row4['label']} <a href='../../scripts/move_task.php?id={$row4['id']}'><br><i class='fa-solid fa-arrow-left button' style='margin-right: 14px; margin-top: 10px;'></i></a><a href='edit/task?id={$row4['id']}'><i class='fa-solid fa-pen button' style='margin-bottom: 16px; margin-right: 8px;'></i></a> <a href='../../scripts/delete_task.php?id={$row4['id']}'><i class='fa-solid fa-trash button'></i></a></h3>";
        }
      }
      echo "</div>
      <div class='main-content' style='width: 20%;'>
