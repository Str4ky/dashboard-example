...
<div class="container">
  <div class="sidebar">
    ...
    <div class="menu-active">
      ...
      <a class="menu-item noselect">Notes</a>
    </div>
    <div class="menu">
  ...
  <div class="main-content">
    ...
    <?php
      $requete = "SELECT id, content FROM notes";
      $resultat = $cnn->query($requete) or die(print_r($bdd->errorInfo()));
      while($row = $resultat->fetch()){
        $temp = html_entity_decode($row['content']);
        $name = substr($temp, 0, 10);
        echo "<a href='note?id={$row['id']}' class='cards'>$name</a>";
      }
    ?>
    <a href="note" class="cards" style="width: 8%;"><i class="fa-solid fa-plus logo2"></i></a>
    </div>
  </div>
</div>
</body>
